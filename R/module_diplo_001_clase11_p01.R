...
module_diplo_001_clase11_p01_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Clase 11 - Parte 01 - Regresión Lineal Simple"),
    shiny::fluidRow(
      shiny::column(12,
...
module_diplo_001_clase11_p01_serverA <- function(id){
    ...
    function(input, output, session) {
      ...
      shiny::observe({
        ...
        output$var_selector01 <- shiny::renderUI({
          ...
          div(
            shiny::selectInput(inputId = ns("selected_x01_name"), label = "X (Independiente - Regresora)",
        ...
        output$var_selector02 <- shiny::renderUI({
          ...
          div(
            shiny::selectInput(inputId = ns("selected_x02_name"), label = "Y (Dependiente - VR)",
                               choices = vector_options,
                               selected = vector_options[1])
          )
      ...
      control_04 <- reactive({
        ...
        # validate(
        #   need((var(vector_x01)!=0), 'Error 015: La variable seleccionada tiene varianza cero. \n
        ...
        validate(
          need((length(vector_x02)>=1), 'Error 015: La variable X02 no posee datos. \n
              Usted, ¿está trabajando con una base de datos de la Diplomatura?.'),
          errorClass = "ERROR"
        )
      ...
      observeEvent(input$render_report_button, {
        ...
        # Selected class
        selected_class_part <- "clase11_p01"
...
module_diplo_001_clase11_p01_serverB <- function(id){
                           ...
                           column(5,
                                  shiny::selectInput(
                                    ...
                                    choices = c(   "Seleccione una... " = "",
                                                   "01 - SEMANA11_BASE01"  = "SEMANA11_BASE01",
                                                   "02 - SEMANA11_BASE02"  = "SEMANA11_BASE02",
                                                   "03 - SEMANA11_BASE03"  = "SEMANA11_BASE03",
                                                   "04 - SEMANA11_BASE04"  = "SEMANA11_BASE04",
                                                   "05 - SEMANA11_BASE05"  = "SEMANA11_BASE05",
                                                   "06 - SEMANA11_BASE06"  = "SEMANA11_BASE06",
                                                   "07 - SEMANA11_BASE07"  = "SEMANA11_BASE07",
                                                   "08 - SEMANA11_BASE08"  = "SEMANA11_BASE08")
                                  )
                           )
                         )
                       )
