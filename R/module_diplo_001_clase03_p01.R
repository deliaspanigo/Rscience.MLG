...
module_diplo_001_clase03_p01_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Clase 03 - Parte 01 - Gráficos para 1 Variable Cualitativa"),
    shiny::fluidRow(
      shiny::column(12,
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      observeEvent(input$render_report_button, {
        ...
        # Selected class
        selected_class_part <- "clase03_p01"
...
module_diplo_001_clase03_p01_serverB <- function(id){
                           ...
                           column(5,
                                  shiny::selectInput(
                                    ...
                                    choices = c(    "Seleccione una..." = "",
                                                "01 - SEMANA03_BASE01"  = "SEMANA03_BASE01",
                                                "02 - SEMANA03_BASE02"  = "SEMANA03_BASE02")
                                  )
                           )
                         )
                       )
