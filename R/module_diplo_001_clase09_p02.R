...
module_diplo_001_clase09_p02_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Clase 09 - Parte 02 - Kruskal-Wallis"),
    shiny::fluidRow(
      shiny::column(12,
...
module_diplo_001_clase09_p02_serverA <- function(id){
...
module_diplo_001_clase09_p02_serverB <- function(id){
