...
module_diplo_001_clase09_p03_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Clase 09 - Parte 01 - Anova 1 Factor con Bloque"),
    shiny::fluidRow(
      shiny::column(12,
...
module_diplo_001_clase09_p03_serverA <- function(id){
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      observeEvent(input$render_report_button, {
        ...
        # Selected class
        selected_class_part <- "clase09_p03"
        ...
        replacement_list$"selected_alpha_value" <- selected_alpha_value()
...
module_diplo_001_clase09_p03_serverB <- function(id){
                           ...
                           column(5,
                                  shiny::selectInput(
                                    ...
                                    choices = c(        "Seleccione una..." = "",
                                                        "01 - SEMANA09_BASE01"  = "SEMANA09_BASE01",
                                                        "02 - SEMANA09_BASE02"  = "SEMANA09_BASE02",
                                                        "03 - SEMANA09_BASE03"  = "SEMANA09_BASE03",
                                                        "04 - SEMANA09_BASE04"  = "SEMANA09_BASE04",
                                                        "05 - SEMANA09_BASE05"  = "SEMANA09_BASE05",
                                                        "06 - SEMANA09_BASE06"  = "SEMANA09_BASE06",
                                                        "07 - SEMANA09_BASE07"  = "SEMANA09_BASE07",
                                                        "08 - SEMANA09_BASE08"  = "SEMANA09_BASE08",
                                                        "09 - SEMANA09_BASE09"  = "SEMANA09_BASE09",
                                                        "10 - SEMANA09_BASE10"  = "SEMANA09_BASE10")
                                  )
                           )
                         )
                       )
