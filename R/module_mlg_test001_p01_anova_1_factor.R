...
module_mlg_test001_p01_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Test 001 - Anova a 1 Factor"),
    # shiny::fluidRow(
    #   shiny::column(12,
    #
...
module_mlg_test001_p01_serverB <- function(id, database){
...
module_mlg_test001_p01_serverA <- function(id, database, code_database){
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      observeEvent(input$render_report_button, {
        ...
        replacement_list$"__selected_vr_name__" <- selected_vr_name()
        replacement_list$"__selected_factor_name__" <- selected_factor_name()
