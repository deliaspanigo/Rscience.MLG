...
module_diplo_001_clase10_p01_ui <- function(id){
  ns <- shiny::NS(id)
  ...
  div(
    ...
    shinyjs::useShinyjs(),
    id = ns("input-panel"),
    shiny::h1("Clase 10 - Parte 01 - Correlación"),
    shiny::fluidRow(
      shiny::column(12,
...
module_diplo_001_clase10_p01_serverA <- function(id){
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      observeEvent(input$render_report_button, {
        ...
        # Selected class
        selected_class_part <- "clase10_p01"
...
module_diplo_001_clase10_p01_serverB <- function(id){
                           ...
                           column(5,
                                  shiny::selectInput(
                                    ...
                                    choices = c(   "Seleccione una... " = "",
                                                "01 - SEMANA10_BASE01"  = "SEMANA10_BASE01",
                                                "02 - SEMANA10_BASE02"  = "SEMANA10_BASE02",
                                                "03 - SEMANA10_BASE03"  = "SEMANA10_BASE03",
                                                "04 - SEMANA10_BASE04"  = "SEMANA10_BASE04",
                                                "05 - SEMANA10_BASE05"  = "SEMANA10_BASE05",
                                                "06 - SEMANA10_BASE06"  = "SEMANA10_BASE06",
                                                "07 - SEMANA10_BASE07"  = "SEMANA10_BASE07")
                                  )
                           )
                         )
                       )
